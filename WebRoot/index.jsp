		...
		<div class="content">
			...
			<div style="float: left; width: 1200px;">
				<table width="100%" border="0" cellpadding="0" cellspacing="1"
					...
					<c:forEach var="server" items="${serverMap}">
					...
					<c:forEach var="server" items="${serverMap}" varStatus="status">
					...
					<tr>
						...
						<td>
							<div class="title" onClick="show('sub${status.index}')">
								查看
							</div>
						</td>
						<td>
					...
					<tr id="masterdiv">
						<td colspan="15"
							style="padding: 0 0 0 10px; line-height: 22px; text-align: left;">
							<span class="submenu" id="sub${status.index}" onclick="remove('sub${status.index}')"> 1111111111111 </span>
						</td>
					</tr>
					</c:forEach>
				</table>
